...
export default function NotFound() {
  ...
  // Safety net: if an old cached JS bundle (served by a stale service worker)
  // doesn't have the /restore-access Wouter route, Wouter falls through here.
  // Render the restore form directly so users are never stuck on a dead 404.
  if (location === "/restore-access") {
    return <InlineRestoreForm />;
  }
