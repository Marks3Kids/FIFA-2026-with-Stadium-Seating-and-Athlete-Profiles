...
<body>
    ...
    async function restore() {
      ...
      try {
        ...
        if (data.valid && data.tier && data.tier !== 'free') {
          ...
          // Unregister stale service workers then navigate
  ...
  // Seed remaining players for all teams not yet covered
  app.post("/api/admin/seed-remaining-players", async (req, res) => {
    try {
      const existingTeams = await storage.getAllTeams();
      const teamIdMap: Record<string, number> = {};
      for (const team of existingTeams) {
      ...
      const T = (name: string) => teamIdMap[name];
      ...
      const remainingPlayers = [
        ...
        { teamId: T("Switzerland"), name: "Breel Embolo", position: "Forward", number: 7, dateOfBirth: "1997-02-14", height: "187cm", currentClub: "AS Monaco", isCaptain: 0, internationalCaps: 55, internationalGoals: 15, clubCareerGoals: 75, clubCareerAssists: 25, highlightVideoUrl: "https://www.youtube.com/results?search_query=breel+embolo+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Breel_Embolo" },
        { teamId: T("Switzerland"), name: "Yann Sommer", position: "Goalkeeper", number: 1, dateOfBirth: "1988-12-17", height: "183cm", currentClub: "Inter Milan", isCaptain: 0, internationalCaps: 88, internationalGoals: 0, clubCareerGoals: 0, clubCareerAssists: 0, highlightVideoUrl: "https://www.youtube.com/results?search_query=yann+sommer+saves", wikiUrl: "https://en.wikipedia.org/wiki/Yann_Sommer" },
        ...
        { teamId: T("Scotland"), name: "Scott McTominay", position: "Midfielder", number: 8, dateOfBirth: "1996-12-08", height: "192cm", currentClub: "Napoli", isCaptain: 0, internationalCaps: 52, internationalGoals: 12, clubCareerGoals: 45, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=scott+mctominay+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Scott_McTominay" },
        { teamId: T("Scotland"), name: "John McGinn", position: "Midfielder", number: 7, dateOfBirth: "1994-10-18", height: "175cm", currentClub: "Aston Villa", isCaptain: 0, internationalCaps: 72, internationalGoals: 10, clubCareerGoals: 45, clubCareerAssists: 30, highlightVideoUrl: "https://www.youtube.com/results?search_query=john+mcginn+highlights", wikiUrl: "https://en.wikipedia.org/wiki/John_McGinn" },
        ...
        // Nigeria
        { teamId: T("Nigeria"), name: "Victor Osimhen", position: "Forward", number: 9, dateOfBirth: "1998-12-29", height: "185cm", currentClub: "Galatasaray", isCaptain: 0, internationalCaps: 42, internationalGoals: 22, clubCareerGoals: 95, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=victor+osimhen+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Victor_Osimhen" },
        { teamId: T("Nigeria"), name: "William Troost-Ekong", position: "Defender", number: 5, dateOfBirth: "1993-09-01", height: "190cm", currentClub: "PAOK", isCaptain: 1, internationalCaps: 72, internationalGoals: 6, clubCareerGoals: 15, clubCareerAssists: 5, highlightVideoUrl: "https://www.youtube.com/results?search_query=troost-ekong+highlights", wikiUrl: "https://en.wikipedia.org/wiki/William_Troost-Ekong" },
        ...
        { teamId: T("Canada"), name: "Jonathan David", position: "Forward", number: 9, dateOfBirth: "2000-01-14", height: "176cm", currentClub: "Lille", isCaptain: 0, internationalCaps: 48, internationalGoals: 28, clubCareerGoals: 100, clubCareerAssists: 30, highlightVideoUrl: "https://www.youtube.com/results?search_query=jonathan+david+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Jonathan_David" },
        { teamId: T("Canada"), name: "Tajon Buchanan", position: "Winger", number: 11, dateOfBirth: "1999-02-08", height: "180cm", currentClub: "Inter Milan", isCaptain: 0, internationalCaps: 40, internationalGoals: 8, clubCareerGoals: 30, clubCareerAssists: 25, highlightVideoUrl: "https://www.youtube.com/results?search_query=tajon+buchanan+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Tajon_Buchanan" },

        // South Korea
        { teamId: T("South Korea"), name: "Son Heung-min", position: "Forward", number: 7, dateOfBirth: "1992-07-08", height: "183cm", currentClub: "Tottenham", isCaptain: 1, internationalCaps: 130, internationalGoals: 50, clubCareerGoals: 230, clubCareerAssists: 110, highlightVideoUrl: "https://www.youtube.com/results?search_query=son+heung+min+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Son_Heung-min" },
        { teamId: T("South Korea"), name: "Lee Kang-in", position: "Midfielder", number: 10, dateOfBirth: "2001-02-19", height: "175cm", currentClub: "PSG", isCaptain: 0, internationalCaps: 38, internationalGoals: 10, clubCareerGoals: 30, clubCareerAssists: 35, highlightVideoUrl: "https://www.youtube.com/results?search_query=lee+kang+in+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Lee_Kang-in" },
        { teamId: T("South Korea"), name: "Kim Min-jae", position: "Defender", number: 3, dateOfBirth: "1996-11-15", height: "190cm", currentClub: "Bayern Munich", isCaptain: 0, internationalCaps: 58, internationalGoals: 4, clubCareerGoals: 8, clubCareerAssists: 3, highlightVideoUrl: "https://www.youtube.com/results?search_query=kim+min+jae+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Kim_Min-jae" },
        ...
        // Iran
        { teamId: T("Iran"), name: "Mehdi Taremi", position: "Forward", number: 9, dateOfBirth: "1992-07-18", height: "185cm", currentClub: "Inter Milan", isCaptain: 1, internationalCaps: 100, internationalGoals: 48, clubCareerGoals: 185, clubCareerAssists: 65, highlightVideoUrl: "https://www.youtube.com/results?search_query=mehdi+taremi+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Mehdi_Taremi" },
        { teamId: T("Iran"), name: "Alireza Beiranvand", position: "Goalkeeper", number: 1, dateOfBirth: "1992-09-21", height: "195cm", currentClub: "Antwerp", isCaptain: 0, internationalCaps: 58, internationalGoals: 0, clubCareerGoals: 0, clubCareerAssists: 0, highlightVideoUrl: "https://www.youtube.com/results?search_query=alireza+beiranvand+saves", wikiUrl: "https://en.wikipedia.org/wiki/Alireza_Beiranvand" },
        { teamId: T("Iran"), name: "Sardar Azmoun", position: "Forward", number: 7, dateOfBirth: "1995-01-01", height: "187cm", currentClub: "Bayer Leverkusen", isCaptain: 0, internationalCaps: 72, internationalGoals: 46, clubCareerGoals: 130, clubCareerAssists: 40, highlightVideoUrl: "https://www.youtube.com/results?search_query=sardar+azmoun+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Sardar_Azmoun" },

        // Saudi Arabia
        { teamId: T("Saudi Arabia"), name: "Salem Al-Dawsari", position: "Winger", number: 10, dateOfBirth: "1991-08-19", height: "172cm", currentClub: "Al-Hilal", isCaptain: 0, internationalCaps: 82, internationalGoals: 25, clubCareerGoals: 75, clubCareerAssists: 55, highlightVideoUrl: "https://www.youtube.com/results?search_query=salem+al+dawsari+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Salem_Al-Dawsari" },
        { teamId: T("Saudi Arabia"), name: "Mohammed Al-Shehri", position: "Forward", number: 9, dateOfBirth: "1993-01-25", height: "183cm", currentClub: "Al-Hilal", isCaptain: 0, internationalCaps: 52, internationalGoals: 22, clubCareerGoals: 65, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=mohammed+al+shehri+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Mohammed_Al-Shehri" },
        { teamId: T("Saudi Arabia"), name: "Mohammed Al-Owais", position: "Goalkeeper", number: 1, dateOfBirth: "1991-08-05", height: "190cm", currentClub: "Al-Hilal", isCaptain: 1, internationalCaps: 70, internationalGoals: 0, clubCareerGoals: 0, clubCareerAssists: 0, highlightVideoUrl: "https://www.youtube.com/results?search_query=al-owais+goalkeeper", wikiUrl: "https://en.wikipedia.org/wiki/Mohammed_Al-Owais" },

        // Australia
        { teamId: T("Australia"), name: "Mat Ryan", position: "Goalkeeper", number: 1, dateOfBirth: "1992-04-08", height: "184cm", currentClub: "Real Sociedad", isCaptain: 1, internationalCaps: 85, internationalGoals: 0, clubCareerGoals: 0, clubCareerAssists: 0, highlightVideoUrl: "https://www.youtube.com/results?search_query=mat+ryan+goalkeeper", wikiUrl: "https://en.wikipedia.org/wiki/Mat_Ryan" },
        { teamId: T("Australia"), name: "Mathew Leckie", position: "Winger", number: 7, dateOfBirth: "1991-02-04", height: "176cm", currentClub: "Melbourne City", isCaptain: 0, internationalCaps: 75, internationalGoals: 12, clubCareerGoals: 60, clubCareerAssists: 30, highlightVideoUrl: "https://www.youtube.com/results?search_query=mathew+leckie+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Mathew_Leckie" },
        ...
        // Panama
        { teamId: T("Panama"), name: "Rolando Blackburn", position: "Forward", number: 9, dateOfBirth: "1994-09-24", height: "175cm", currentClub: "Cagliari", isCaptain: 0, internationalCaps: 40, internationalGoals: 12, clubCareerGoals: 40, clubCareerAssists: 15, highlightVideoUrl: "https://www.youtube.com/results?search_query=rolando+blackburn+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Rolando_Blackburn" },
        { teamId: T("Panama"), name: "Adalberto Carrasquilla", position: "Midfielder", number: 8, dateOfBirth: "1998-12-28", height: "176cm", currentClub: "Houston Dynamo", isCaptain: 0, internationalCaps: 35, internationalGoals: 5, clubCareerGoals: 12, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=adalberto+carrasquilla+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Adalberto_Carrasquilla" },

        // Costa Rica
        { teamId: T("Costa Rica"), name: "Keylor Navas", position: "Goalkeeper", number: 1, dateOfBirth: "1986-12-15", height: "185cm", currentClub: "Herediano", isCaptain: 0, internationalCaps: 120, internationalGoals: 0, clubCareerGoals: 0, clubCareerAssists: 0, highlightVideoUrl: "https://www.youtube.com/results?search_query=keylor+navas+saves", wikiUrl: "https://en.wikipedia.org/wiki/Keylor_Navas" },
        { teamId: T("Costa Rica"), name: "Bryan Ruiz", position: "Midfielder", number: 10, dateOfBirth: "1985-08-18", height: "186cm", currentClub: "Retired", isCaptain: 1, internationalCaps: 132, internationalGoals: 32, clubCareerGoals: 90, clubCareerAssists: 65, highlightVideoUrl: "https://www.youtube.com/results?search_query=bryan+ruiz+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Bryan_Ruiz" },
        { teamId: T("Costa Rica"), name: "Joel Campbell", position: "Winger", number: 7, dateOfBirth: "1992-06-26", height: "177cm", currentClub: "Herediano", isCaptain: 0, internationalCaps: 105, internationalGoals: 22, clubCareerGoals: 75, clubCareerAssists: 40, highlightVideoUrl: "https://www.youtube.com/results?search_query=joel+campbell+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Joel_Campbell" },

        // Honduras
        { teamId: T("Honduras"), name: "Romell Quioto", position: "Winger", number: 11, dateOfBirth: "1991-08-09", height: "173cm", currentClub: "Al-Qadsiah", isCaptain: 0, internationalCaps: 60, internationalGoals: 15, clubCareerGoals: 50, clubCareerAssists: 30, highlightVideoUrl: "https://www.youtube.com/results?search_query=romell+quioto+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Romell_Quioto" },
        { teamId: T("Honduras"), name: "Alberth Elis", position: "Winger", number: 7, dateOfBirth: "1996-02-12", height: "185cm", currentClub: "Bordeaux", isCaptain: 0, internationalCaps: 55, internationalGoals: 12, clubCareerGoals: 55, clubCareerAssists: 25, highlightVideoUrl: "https://www.youtube.com/results?search_query=alberth+elis+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Alberth_Elis" },

        // Iraq
        { teamId: T("Iraq"), name: "Aymen Hussein", position: "Forward", number: 9, dateOfBirth: "1997-07-10", height: "183cm", currentClub: "Al-Zawra", isCaptain: 0, internationalCaps: 40, internationalGoals: 16, clubCareerGoals: 55, clubCareerAssists: 15, highlightVideoUrl: "https://www.youtube.com/results?search_query=aymen+hussein+iraq+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Aymen_Hussein" },
        ...
        { teamId: T("South Africa"), name: "Ronwen Williams", position: "Goalkeeper", number: 1, dateOfBirth: "1992-08-25", height: "183cm", currentClub: "Mamelodi Sundowns", isCaptain: 1, internationalCaps: 38, internationalGoals: 0, clubCareerGoals: 0, clubCareerAssists: 0, highlightVideoUrl: "https://www.youtube.com/results?search_query=ronwen+williams+goalkeeper", wikiUrl: "https://en.wikipedia.org/wiki/Ronwen_Williams" },

        // Ghana
        { teamId: T("Ghana"), name: "Thomas Partey", position: "Midfielder", number: 5, dateOfBirth: "1993-06-13", height: "185cm", currentClub: "Arsenal", isCaptain: 1, internationalCaps: 50, internationalGoals: 13, clubCareerGoals: 25, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=thomas+partey+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Thomas_Partey" },
        { teamId: T("Ghana"), name: "Jordan Ayew", position: "Forward", number: 11, dateOfBirth: "1991-09-11", height: "178cm", currentClub: "Leicester City", isCaptain: 0, internationalCaps: 100, internationalGoals: 22, clubCareerGoals: 95, clubCareerAssists: 35, highlightVideoUrl: "https://www.youtube.com/results?search_query=jordan+ayew+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Jordan_Ayew" },
        { teamId: T("Ghana"), name: "Mohammed Kudus", position: "Midfielder", number: 10, dateOfBirth: "2000-08-02", height: "179cm", currentClub: "West Ham", isCaptain: 0, internationalCaps: 40, internationalGoals: 16, clubCareerGoals: 45, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=mohammed+kudus+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Mohammed_Kudus" },

        // Tunisia
        { teamId: T("Tunisia"), name: "Hannibal Mejbri", position: "Midfielder", number: 10, dateOfBirth: "2002-01-21", height: "182cm", currentClub: "Burnley", isCaptain: 0, internationalCaps: 28, internationalGoals: 4, clubCareerGoals: 12, clubCareerAssists: 15, highlightVideoUrl: "https://www.youtube.com/results?search_query=hannibal+mejbri+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Hannibal_Mejbri" },
        { teamId: T("Tunisia"), name: "Wahbi Khazri", position: "Forward", number: 9, dateOfBirth: "1991-02-08", height: "184cm", currentClub: "Montpellier", isCaptain: 0, internationalCaps: 72, internationalGoals: 25, clubCareerGoals: 95, clubCareerAssists: 40, highlightVideoUrl: "https://www.youtube.com/results?search_query=wahbi+khazri+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Wahbi_Khazri" },

        // Cape Verde
        { teamId: T("Cape Verde"), name: "Gilson Tavares", position: "Forward", number: 9, dateOfBirth: "1998-04-08", height: "183cm", currentClub: "Vitoria SC", isCaptain: 0, internationalCaps: 30, internationalGoals: 8, clubCareerGoals: 35, clubCareerAssists: 10, highlightVideoUrl: "https://www.youtube.com/results?search_query=cape+verde+football+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Cape_Verde_national_football_team" },
        { teamId: T("Cape Verde"), name: "Jamiro Monteiro", position: "Midfielder", number: 10, dateOfBirth: "1994-12-25", height: "177cm", currentClub: "Stade Reims", isCaptain: 1, internationalCaps: 42, internationalGoals: 8, clubCareerGoals: 25, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=jamiro+monteiro+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Jamiro_Monteiro" },

        // Uzbekistan
        { teamId: T("Uzbekistan"), name: "Eldor Shomurodov", position: "Forward", number: 9, dateOfBirth: "1995-06-29", height: "187cm", currentClub: "Roma", isCaptain: 0, internationalCaps: 50, internationalGoals: 20, clubCareerGoals: 65, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=eldor+shomurodov+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Eldor_Shomurodov" },
        { teamId: T("Uzbekistan"), name: "Abbosbek Fayzullayev", position: "Midfielder", number: 10, dateOfBirth: "2002-02-15", height: "178cm", currentClub: "Sporting CP", isCaptain: 0, internationalCaps: 28, internationalGoals: 5, clubCareerGoals: 18, clubCareerAssists: 22, highlightVideoUrl: "https://www.youtube.com/results?search_query=abbosbek+fayzullayev+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Abbosbek_Fayzullayev" },

        // Jordan
        { teamId: T("Jordan"), name: "Yazan Al-Naimat", position: "Forward", number: 9, dateOfBirth: "1997-03-10", height: "180cm", currentClub: "Al-Wihdat", isCaptain: 0, internationalCaps: 38, internationalGoals: 12, clubCareerGoals: 45, clubCareerAssists: 12, highlightVideoUrl: "https://www.youtube.com/results?search_query=jordan+national+football+team", wikiUrl: "https://en.wikipedia.org/wiki/Jordan_national_football_team" },
        { teamId: T("Jordan"), name: "Baha' Abdulrahman", position: "Midfielder", number: 10, dateOfBirth: "1993-08-21", height: "175cm", currentClub: "Al-Wehdat", isCaptain: 1, internationalCaps: 52, internationalGoals: 8, clubCareerGoals: 30, clubCareerAssists: 20, highlightVideoUrl: "https://www.youtube.com/results?search_query=jordan+football", wikiUrl: "https://en.wikipedia.org/wiki/Jordan_national_football_team" },

        // New Zealand
        { teamId: T("New Zealand"), name: "Chris Wood", position: "Forward", number: 9, dateOfBirth: "1991-12-07", height: "190cm", currentClub: "Newcastle United", isCaptain: 1, internationalCaps: 68, internationalGoals: 35, clubCareerGoals: 175, clubCareerAssists: 30, highlightVideoUrl: "https://www.youtube.com/results?search_query=chris+wood+highlights", wikiUrl: "https://en.wikipedia.org/wiki/Chris_Wood_(footballer,_born_1991)" },
        { teamId: T("New Zealand"), name: "Clayton Lewis", position: "Midfielder", number: 10, dateOfBirth: "1997-12-02", height: "176cm", currentClub: "New England Revolution", isCaptain: 0, internationalCaps: 38, internationalGoals: 6, clubCareerGoals: 20, clubCareerAssists: 15, highlightVideoUrl: "https://www.youtube.com/results?search_query=new+zealand+football+highlights", wikiUrl: "https://en.wikipedia.org/wiki/New_Zealand_national_football_team" },

        // Indonesia
        { teamId: T("Indonesia"), name: "Ragnar Oratmangoen", position: "Winger", number: 11, dateOfBirth: "1999-02-13", height: "177cm", currentClub: "Fortuna Sittard", isCaptain: 0, internationalCaps: 20, internationalGoals: 4, clubCareerGoals: 20, clubCareerAssists: 12, highlightVideoUrl: "https://www.youtube.com/results?search_query=indonesia+football+2026", wikiUrl: "https://en.wikipedia.org/wiki/Ragnar_Oratmangoen" },
        { teamId: T("Indonesia"), name: "Marcelino Ferdinand", position: "Midfielder", number: 8, dateOfBirth: "2000-09-09", height: "175cm", currentClub: "Venezia", isCaptain: 0, internationalCaps: 18, internationalGoals: 2, clubCareerGoals: 12, clubCareerAssists: 10, highlightVideoUrl: "https://www.youtube.com/results?search_query=indonesia+football+2026", wikiUrl: "https://en.wikipedia.org/wiki/Indonesia_national_football_team" },
        { teamId: T("Indonesia"), name: "Shin Tae-yong", position: "Midfielder", number: 10, dateOfBirth: "1998-11-15", height: "178cm", currentClub: "Persib Bandung", isCaptain: 1, internationalCaps: 35, internationalGoals: 8, clubCareerGoals: 30, clubCareerAssists: 18, highlightVideoUrl: "https://www.youtube.com/results?search_query=indonesia+football+2026", wikiUrl: "https://en.wikipedia.org/wiki/Indonesia_national_football_team" },
      ];

      const validPlayers = remainingPlayers.filter(p => p.teamId !== undefined && p.teamId !== null);
      let seededCount = 0;
      let skippedCount = 0;
      ...
      res.json({
        success: true,
        message: `Added ${seededCount} players across all teams (${skippedCount} skipped as already existing)`,
        results: { players: seededCount, skipped: skippedCount },
      });
    } catch (error) {
      console.error("Seed remaining players error:", error);
      res.status(500).json({ error: "Failed to seed remaining players: " + String(error) });
    }
  });
...
Remember: You're helping fans have the best World Cup experience of their lives!`;
  ...
  app.get("/api/admin/purchases/export", async (req, res) => {
    try {
      ...
      const csvRows = purchases.map(p =>
        `${p.id},"${p.email}","${p.tier}","${p.stripeSessionId || ''}","${p.purchasedAt}"`
      ).join("\n");
  ...
  // Admin: Update teams with final FIFA 2026 qualified teams
  app.post("/api/admin/update-teams", async (req, res) => {
    try {
      ...
      const updatedTeams = [
        ...
        { name: "Canada", teamName: "Les Rouges", flag: "ca", rank: 27, coach: "Jesse Marsch", record: "6-4-5", points: "1590.00" },
        { name: "Panama", teamName: "Los Canaleros", flag: "pa", rank: 30, coach: "Thomas Christiansen", record: "6-3-6", points: "1560.00" },
        { name: "Costa Rica", teamName: "Los Ticos", flag: "cr", rank: 44, coach: "Claudio Vivas", record: "5-4-6", points: "1480.00" },
        { name: "Honduras", teamName: "La Bicolor", flag: "hn", rank: 72, coach: "Reinaldo Rueda", record: "4-4-7", points: "1370.00" },
        // UEFA (16)
        { name: "Spain", teamName: "La Roja", flag: "es", rank: 1, coach: "Luis de la Fuente", record: "12-2-1", points: "1877.18" },
        { name: "France", teamName: "Les Bleus", flag: "fr", rank: 3, coach: "Didier Deschamps", record: "10-4-2", points: "1870.00" },
        { name: "England", teamName: "Three Lions", flag: "gb-eng", rank: 4, coach: "Thomas Tuchel", record: "9-5-2", points: "1834.12" },
      ...
      for (const team of updatedTeams) {
        if (existingNames.has(team.name)) {
          ...
          await db.update(teamsTable)
            .set(team)
            .where(inArray(teamsTable.name, [team.name]));
          updated++;
        } else {
          // Add new team
          await storage.createTeam(team);
      ...
      res.json({
        success: true,
        message: `Teams updated: ${updated} updated, ${added} added, ${teamsToRemove.length} removed`,
        removed: teamsToRemove,
        total: updatedTeams.length,
      });
    } catch (error) {
      console.error("Failed to update teams:", error);
      res.status(500).json({ error: "Failed to update teams: " + String(error) });
    }
  });
